...
#undef const_strv
    ...
    if (retval < 0) {
        g_warning ("Invalid categories %s for panel %s", categories, g_app_info_get_id (G_APP_INFO (app)));
    }
 ...
 */
void
cc_panel_loader_override_vtable (CcPanelLoaderVtable *override_vtable, gsize n_elements)
{
