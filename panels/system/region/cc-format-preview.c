...
static void
cc_format_preview_set_property (GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec)
{
...
static void
cc_format_preview_get_property (GObject *object, guint prop_id, GValue *value, GParamSpec *pspec)
{
    CcFormatPreview *self;
...
void
cc_format_preview_set_region (CcFormatPreview *self, const gchar *region)
{
