...
G_DEFINE_FINAL_TYPE (CcSecureShellPage, cc_secure_shell_page, ADW_TYPE_DIALOG)
...
cc_secure_shell_page_init (CcSecureShellPage *self)
{
    ...
    g_signal_connect_object (self->secure_shell_row, "notify::active", G_CALLBACK (secure_shell_row_activate), self,
                             G_CONNECT_SWAPPED);
